        ...
        <nav style={{
            ...
            {session ? (
                <div style={{ display:"flex", alignItems:"center", gap:8, paddingLeft:4 }}>
                    {session.user?.image
                        ? <img src={session.user.image} referrerPolicy="no-referrer" alt="" style={{ width:26, height:26, borderRadius:"50%", border:"1.5px solid rgba(255,255,255,.18)", flexShrink:0 }}/>
